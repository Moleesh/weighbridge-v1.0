...
ALTER TABLE SETTINGS     ADD COLUMN IF NOT EXISTS  ESTIMATED_WEIGHT_SETTING	            BOOLEAN 		DEFAULT FALSE;
...
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  OPERATOR_TARE                        VARCHAR(100)    DEFAULT '';
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  OPERATOR_GROSS                       VARCHAR(100)    DEFAULT '';
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  CREDIT                               BOOLEAN         DEFAULT FALSE;
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  CUSTOM_1                             VARCHAR(100)    DEFAULT '';
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  CUSTOM_2                             VARCHAR(100)    DEFAULT '';
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  CUSTOM_3                             VARCHAR(100)    DEFAULT '';
ALTER TABLE WEIGHING     ADD COLUMN IF NOT EXISTS  CUSTOM_4                             VARCHAR(100)    DEFAULT '';
